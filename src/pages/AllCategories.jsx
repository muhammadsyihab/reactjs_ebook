...
import ACCSection1 from '../components/AllCategoriesComponents/ACCSection1'
import ACCFilter from '../components/AllCategoriesComponents/ACCFilter'
import ACCBooks from '../components/AllCategoriesComponents/ACCBooks'
import ACCPagination from '../components/AllCategoriesComponents/ACCPagination'
...
"focusOnSelect": true
        ...
        <section className="section-margin">
          ...
          <div className="container">
            <div
              className="brand-slider sb-slick-slider border-top border-bottom"
              data-slick-setting='{
                              "autoplay": true,
                              "autoplaySpeed": 8000,
                              "slidesToShow": 6
